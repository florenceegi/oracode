---
title: Oracode Nexus — Index Documenti Vitali
slug: oracode-nexus-index
doc_type: concept
version: 1.0.0
status: current
date: '2026-05-29'
...
| **Asse Difesa Costitutivo — Egida** | modulo `oracode/docs/paradigm/modules/EGIDA_ASSE_DIFESA.md` + CORE §Asse Difesa Costitutivo (il charter di fondazione è record storico d'istanza, fuori dal prodotto — CEO 2026-07-11, confermato 2026-08-27) | **In OSZ da M-NEXUS-005** (4 [DECISIONE CEO] ratificati 2026-06-08). Clausola: *"un LSO si difende e prova la propria difesa, in proporzione al rischio; chi non lo fa non è un LSO"*. **Fortino** difende (runtime) · **DeepDebug** collauda (banco di prova, esiste già) · **Egida** = usarli insieme · **Sigillo** certifica. Difesa = parte della definizione di LSO. Profilo scalato sul livello (vetrina→leggero, denaro/PII/blockchain→pieno). |
