...
**Meccanismo.** Supervisor consulta `MISSION_BOOTSTRAP_INDEX.json` (vedi 4.3) per identificare quali moduli caricare in base a `type` + `organs`. I moduli sono stratificati secondo `LSO_NOMENCLATURE_v1.md`:
